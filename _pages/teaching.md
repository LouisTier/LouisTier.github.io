...
<div class="row mt-3">
    <div class="col-md-8 mb-3">
        <div class="card">
            <div class="card-body">
                <h6 class="card-title">Introduction to Machine Learning and Data Science</h6>
                ...
                <p class="card-text small">
                    Teaching assistant for first-year engineering students (Bachelor 3 equivalent), with 20 to 25 students per session.
