        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-start mb-3">
                    <h3 class="card-title mb-0"><i class="fa-solid fa-trophy me-2"></i> Ma Thèse en 180 secondes (MT180)</h3>
                ...
                <div class="row mt-3 mb-3">
                    <div class="col-md-6 text-center">
                        <p class="text-muted mb-2">
                            <i class="fa-solid fa-calendar me-2"></i><strong> Date:</strong> April, 2025<br>
                            <i class="fa-solid fa-map-marker-alt me-2"></i><strong> Location:</strong> École Polytechnique<br>
                ...
                <div class="row mb-3">
                    <div class="col-md-12 d-flex gap-2 justify-content-center">
                        ...
                        <a href="https://www.polytechnique.edu/actualites/les-doctorantes-et-doctorants-des-laboratoires-de-lx-lhonneur-pour-mt180" class="btn btn-danger" target="_blank" role="button">
                            <i class="fa-solid fa-trophy me-1"></i> See Award Results
                        </a>
                    </div>
                </div>
            </div>
